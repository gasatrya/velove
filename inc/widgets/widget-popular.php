 ...
 */
class Velove_Popular_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        $widget_ops = array(
            ...
            'description' => esc_html__('Display your site\'s most popular Posts with thumbnails.', 'velove'),
            'customize_selective_refresh' => true
        );

        // Create the widget.
        parent::__construct(
            'velove-popular-posts',                           // $this->id_base
            esc_html__('Velove - Popular Posts', 'velove'), // $this->name
    ...
    public function widget($args, $instance) {
        ...
        $query = apply_filters('velove_widget_popular_args', $query);
    ...
    public function form($instance) {
        $title     = isset($instance['title']) ? esc_attr($instance['title']) : esc_html__('Popular Posts', 'velove');
