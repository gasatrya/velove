 ...
 * Video widget.
 */
class Velove_Video_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => esc_html__( 'Display any type of video from any video provider.', 'velove' ),
			'customize_selective_refresh' => true
		);

		// Create the widget.
		parent::__construct(
			'velove-video',                             // $this->id_base
			esc_html__( 'Velove - Video', 'velove' ), // $this->name
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'url' ); ?>">
				<?php esc_html_e( 'Video URL', 'velove' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'code' ); ?>">
				<?php esc_html_e( 'Embed Code', 'velove' ); ?>
			</label>
