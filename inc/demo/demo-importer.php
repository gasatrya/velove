...
add_filter( 'pt-ocdi/import_files', 'velove_import_files' );

/**
 * After import function
 */
function velove_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'velove_after_import_setup' );
